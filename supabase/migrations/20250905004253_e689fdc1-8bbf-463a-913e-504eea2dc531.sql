-- Fix roles table schema and policies, then insert template
-- Ensure column exists
ALTER TABLE mc.roles ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT true;

-- Recreate view policy to avoid referencing missing column
...
-- Insert or bump version of the Onboarding template
WITH latest AS (
