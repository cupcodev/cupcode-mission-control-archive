...
DROP POLICY IF EXISTS "Admins can manage roles" ON mc.roles;
DROP POLICY IF EXISTS "Everyone can view active roles" ON mc.roles;
DROP POLICY IF EXISTS "Admins can manage role members" ON mc.role_members;
DROP POLICY IF EXISTS "Users can view their own role memberships" ON mc.role_members;
DROP POLICY IF EXISTS "Admins can manage assignment rules" ON mc.assignment_rules;
